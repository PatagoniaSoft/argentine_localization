 ...
 * de Epson a implementar deber�a ser una especializaci�n de esta clase,
...

{
	...
	/** C�digo de barras EAN 8 */
	protected static final Integer EAN_8 = 3;
	/** C�digo de barras UPCA */
	protected static final Integer UPCA  = 0;
	/** C�digo de barras ITF 2 de 5 */
	protected static final Integer ITF = 5;
	
	
	// Opciones de operaci�n del comando ReturnRecharge
	/** ReturnRecharge: Operaci�n Devoluci�n de Envases */
	protected static final String CONTAINER_RETURN = "e";
	/** ReturnRecharge: Operaci�n Descuento / Recargo */
	protected static final String DISCOUNT_RECHARGE = "B";
	
	
	/** Conjunto de caracteres para realizar la conversi�n a string de los paquetes fiscales */
	private String encoding = "ISO8859_1";	// ISO 8859-1, Latin alphabet No. 1.
	/** A�o base para validaci�n de fechas */
	...
	/** C�digos de mensajes de estado de la impresora *///*faltan las conStantes
	...
	/** Mapeo entre los tipos de identificaci�n de clientes de las clases
...
//	}
	...
	protected FiscalPacket execute(FiscalPacket command) throws FiscalPrinterIOException, FiscalPrinterStatusError {
		...
		// Se guarda el comando como el �ltimo ejecutado.
		setLastRequest(command);
		setLastResponse(null);

		try {
			// Se env�a el comando a la interfaz de comunicaci�n para
			// ser ejecutado.
		...
		// Se informa al manejador que el comando se ejecut� satisfactoriamente.
